                    ...
                    prev.map((it) =>
                      it.id === item.id
                        ? // MANUAL, not COVER. Dates typed in by a person are
                          // not dates read off the flyer, and labeling them
      ...
      {finishedAt && totals.needsDates > 0 ? (
        <div className="mb-4">
          <Notice tone="warn" title="Some flyers have no dates">
            ...
            &ldquo;still valid?&rdquo; is the first thing asked at checkout. Set
      ...
      */}
      ...
      {item.saved ? (
        <p className="mt-1 text-xs text-good">
          ...
          {item.saved.pages > 0
            ? `, ${item.saved.pages} pages kept for checkout`
 ...
 * a flyer nobody takes to checkout.
 */
